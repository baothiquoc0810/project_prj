 ...
 * @author bquoc
 */
@WebServlet(name = "DetailUsersServlet", urlPatterns = {"/detailUsers"})
public class DetailUsersServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet DetailUsersServlet</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet DetailUsersServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (user == null || user.getRole() == null || user.getRole().getName() == null) {
            ...
            List<MovieAndTotalOrders> movieAndTotalOrders = dao.getListMovieAndTotalOrders();
            ...
            String chartJson = new Gson().toJson(movieAndTotalOrders).replace("'", "\\'");
            request.setAttribute("chart", chartJson);
